...
@section('content')
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="ajax_create_content">
                    ...
                    <div class="form-group">
                        ...
                        @if (lang() == 'ar')
                            <div class="form-group">
                                {!! Form::select('country_id', App\Models\Country::pluck('name_ar', 'id'), old('name_ar'), [
                        ...
                        @else
                            <div class="form-group">
                                {!! Form::select('country_id', App\Models\Country::pluck('name_en', 'id'), old('name_en'), [
                                    'placeholder' => trans('admin.country') . '...',
                                    'class' => 'form-control',
                                ]) !!}
                            </div>
    ...
    @push('js')
        ...
        @include('admin.cities.modals.script')
    @endpush
@endsection
