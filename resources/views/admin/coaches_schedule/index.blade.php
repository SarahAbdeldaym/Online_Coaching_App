...
@section('content')
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="ajax_create_content">
                    ...
                    <input type="hidden" name="coach_id" id="coach_id" value="{{ request('coach_id') }}">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('session_duration', old('session_duration'), ['class' => 'form-control']) !!}
                    </div>
    ...
    @push('js')
        ...
        @include('admin.coaches_schedule.modals.script')
    @endpush
@endsection
