<script>
    ...
    $(document).ready(function() {
        ...
        $('#store_form').on('submit', function(event) {
            ...
            $.ajax({
                url: "{{ route('coaches_schedule.store') }}",
                method: "POST",
    ...
    $(document).ready(function() {
        $(document).on('click', '.show-ajax', function() {
            $.ajax({
                url: '{{ adminUrl('') }}/coaches_schedule/' + $(this).data('ajax'),
                type: 'get',
                success: function(data) {
    ...
    $(document).ready(function() {
        $(document).on('click', '.edit-ajax', function() {
            ...
            $.ajax({
                url: '{{ adminUrl('') }}/coaches_schedule/' + $(this).data('ajax') + '/edit',
                type: 'get',
                success: function(data) {
    ...
    $(document).ready(function() {
        $(document).on('submit', '#update_form', function(event) {
            ...
            $.ajax({
                url: '{{ adminUrl('') }}/coaches_schedule/' + $('#ajax_edit_content #id').val() +
                    '/update',
                method: "post",
                data: new FormData(this),
                contentType: false,
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#ajax_delete_content #delete', function() {
            $.ajax({
                url: '{{ adminUrl('') }}/coaches_schedule/' + _id,
                type: 'delete',
                data: {
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '#ajax_delete_all', function() {
            ...
            $.ajax({
                url: '{{ route('coaches_schedule.destroyAll') }}',
                type: 'delete',
                data: {
    ...
    function clearFields() {
        ...
        $('#ajax_create_content #session_duration').val('');
        $('#ajax_create_content #coach_id').val('');
