    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown user user-menu">
            <a class="nav-link" data-toggle="dropdown" href="#">
                ...
                @else
                    <img src="{{ url('/design/adminlte') }}/dist/img/avatar5.png" style="width: 35px; height: 35px;"
                        class="img-circle" alt="User Image">
                @endif
                ...
                <li class="user-footer">
                    <div class="row">
                        <div class="col-sm-4 text-center">
                            <button type="button" class="btn btn-primary btn-sm btn-flat" style="border-radius: 3px;"
                                data-toggle="modal" data-target="#exampleModal">Profile</button>
                        </div>
                        <div class="col-sm-4 text-center">
                            <a href="{{ adminUrl('logout') }}" class="btn btn-primary btn-flat">@lang('admin.Logout')</a>
                        </div>
                    </div>
                </li>
            </ul>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="text" name="id" class="hidden" id="id"
                    value="{{ isset($admin) ? $admin->id : admin()->user()->id }}">

                <div class="form-group">
                    {!! Form::label('name_en', trans('admin.name_en')) !!}
                    {!! Form::text('name_en', isset($admin) ? $admin->name_en : admin()->user()->name_en, [
                        'class' => 'form-control',
                    ]) !!}
                </div>
                <div class="form-group">
                    {!! Form::label('name_ar', trans('admin.name_ar')) !!}
                    {!! Form::text('name_ar', isset($admin) ? $admin->name_ar : admin()->user()->name_ar, [
                        'class' => 'form-control',
                    ]) !!}
                </div>
                    ...
                    <div class="avatar-upload">
                        ...
                        <div class="avatar-preview">
                            <div id="imagePreview-edit"
                                style="background-image: url({{ url('storage/' . (isset($admin) ? $admin->image : admin()->user()->image)) }});">
                            </div>
                        </div>
                    </div>
                </div>
