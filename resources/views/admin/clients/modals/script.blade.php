<script>
    ...
    $(document).ready(function() {
        $(document).on('click', '.show-ajax', function() {
            $.ajax({
                url: '{{ adminUrl('') }}/clients/' + $(this).data('ajax'),
                type: 'get',
                success: function(data) {
    ...
    $(document).ready(function() {
        $(document).on('click', '.edit-ajax', function() {
            ...
            $.ajax({
                url: '{{ adminUrl('') }}/clients/' + $(this).data('ajax') + '/edit',
                type: 'get',
                success: function(data) {
    ...
    $(document).ready(function() {
        $(document).on('submit', '#update_form', function(event) {
            ...
            $.ajax({
                url: '{{ adminUrl('') }}/clients/' + $('#ajax_edit_content #id').val() +
                    '/update',
                method: "post",
                data: formData,
                contentType: false,
    ...
    function clearFields() {
        ...
        $('#ajax_create_content #imagePreview-create').css({'background-image' : 'url({{ url('storage/images/clients/default_client.png') }})'});
