<script>
    ...
    $(document).ready(function() {
        $(document).on('click', '.show-ajax', function() {
            $.ajax({
                url: '{{ adminUrl('') }}/countries/' + $(this).data('ajax'),
                type: 'get',
                success: function(data) {
    ...
    $(document).ready(function() {
        $(document).on('click', '.edit-ajax', function() {
            ...
            $.ajax({
                url: '{{ adminUrl('') }}/countries/' + $(this).data('ajax') + '/edit',
                type: 'get',
                success: function(data) {
    ...
    $(document).ready(function() {
        $(document).on('submit', '#update_form', function(event) {
            ...
            $.ajax({
                url: '{{ adminUrl('') }}/countries/' + $('#ajax_edit_content #id').val() +
                    '/update',
                method: "post",
                data: new FormData(this),
                contentType: false,
