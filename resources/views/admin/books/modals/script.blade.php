<script>
    ...
    $(document).ready(function() {
        $(document).on('click', '.show-ajax', function() {
            $.ajax({
                url: '{{ adminUrl('') }}/books/' + $(this).data('ajax'),
                type: 'get',
                success: function(data) {
    ...
    $(document).ready(function() {
        $(document).on('click', '.edit-ajax', function() {
            ...
            $.ajax({
                url: '{{ adminUrl('') }}/books/' + $(this).data('ajax') + '/edit',
                type: 'get',
                success: function(data) {
    ...
    $(document).ready(function() {
        $(document).on('submit', '#update_form', function(event) {
            event.preventDefault();
            $.ajax({
                url: '{{ adminUrl('') }}/books/' + $('#ajax_edit_content #id').val() +
                    '/update',
                method: "post",
                data: new FormData(this),
                contentType: false,
    ...
    function clearFields() {
        ...
        $('#ajax_create_content #client_id').val('');
