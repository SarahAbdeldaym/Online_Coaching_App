        ...
        <li class="nav-item dropdown user user-menu">
            ...
            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <li class="user-header">
                    @if (!empty(coach()->user()->image))
                        <img src="{{ url('storage/' . coach()->user()->image) }}" style="" class="img-circle"
                            alt="User Image" />
                    @else
                        <img src="{{ url('/design/adminlte') }}/dist/img/avatar5.png" class="img-circle"
                            alt="User Image">
                    @endif
                    ...
                    <div class="row">
                        <div class="col-sm-6 text-center">
                            <a href="{{ route('coach.profile') }}"
                                class="btn btn-primary btn-flat">@lang('admin.Profile')</a>
                        </div>
                        <div class="col-sm-6 text-center">
